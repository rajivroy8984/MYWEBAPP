...
/**
 * The Class FindCurrencyImpl.
 */
@Service
public class FindCurrencyImpl implements FindCurrency{
	 ...
	 */
	@Override
	public String findCurrenecy(String currency) {
		return convertToIndianCurrency(currency);
	}
	...
	public static String convertToIndianCurrency(String num) {
		try {
			...
			if(paise.length()>0) {
				return Rupees +" dollar "+ paise + " cents Only";
			}else {
				return Rupees +" dollar "+"Only";
			}
